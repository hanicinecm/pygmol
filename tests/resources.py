...
class DefaultChemistry(Chemistry):
    ...
    species_surface_sticking_coefficients = [0., 1.]
    ...
    reactions_arrh_b = [-1.28e-02, 4.46e-01, -1.22e+00]
    reactions_arrh_c = [3.15e+00, 1.70e+01, 3.82e-02]
    reactions_el_energy_losses = [0., 15.875, 0.]
